"""Revise activity — selective re-translation of flagged segments via gpt-4.1.

Only segments with guardrail issues or per-segment judge score < SEGMENT_PASS_FLOOR
are revised; the rest are kept verbatim to avoid regressions.
"""
    ...
    for i in range(0, len(to_fix), BATCH_SIZE):
        ...
        for s in batch:
            ...
            if new_text:
                ...
                s.guardrail_issues = []  # re-checked downstream
